...
class ArticleSummaryQueryModelFixtureTest {
    ...
    fun test2() {
        ...
        assertThat(articleSummary.articleCategory.articleCategoryId).isEqualTo(articleCategoryId)
        assertThat(articleSummary.articleCategory.name).isEqualTo(articleCategoryName)
        assertThat(articleSummary.articleCategory.slug).isEqualTo(articleCategorySlug)
        assertThat(articleSummary.board.boardId).isEqualTo(boardId)
        assertThat(articleSummary.board.name).isEqualTo(boardName)
        assertThat(articleSummary.board.slug).isEqualTo(boardSlug)
        assertThat(articleSummary.writer.writerId).isEqualTo(writerId)
        assertThat(articleSummary.writer.nickname).isEqualTo(writerNickname)
