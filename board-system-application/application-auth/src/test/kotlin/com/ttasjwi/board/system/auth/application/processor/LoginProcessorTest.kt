...
class LoginProcessorTest {
    ...
    fun testFirstLoginSuccess() {
        ...
        assertThat(refreshTokenHolder.authMember.email).isEqualTo(savedMember.email)
        assertThat(refreshTokenHolder.authMember.username).isEqualTo(savedMember.username)
        assertThat(refreshTokenHolder.authMember.nickname).isEqualTo(savedMember.nickname)
