...
class AccessTokenGeneratorFixtureTest {

    private lateinit var accessTokenManagerFixture: AccessTokenGeneratorFixture

    @BeforeEach
    fun setup() {
        accessTokenManagerFixture = AccessTokenGeneratorFixture()
    }

    companion object {
        private val log = getLogger(AccessTokenGeneratorFixtureTest::class.java)
    }
    ...
    inner class Generate {
        ...
        fun test() {
            ...
            assertThat(accessToken.expiresAt).isEqualTo(issuedAt.plusMinutes(AccessTokenGeneratorFixture.VALIDITY_MINUTES))
