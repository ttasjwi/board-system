...
class ExternalJwtAccessTokenManagerTest : IntegrationTest() {
...
//            val parsedAccessToken = accessTokenGenerator.parse(tokenValue)
//
...
//
//            val exception =
//                assertThrows<InvalidAccessTokenFormatException> { accessTokenGenerator.parse(tokenValue) }
