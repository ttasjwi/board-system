package com.ttasjwi.board.system.common.websupport.exception.config

import com.ttasjwi.board.system.common.websupport.exception.filter.CustomExceptionHandleFilter
...
@Configuration
@ComponentScan(basePackages = ["com.ttasjwi.board.system.common.websupport.exception"])
