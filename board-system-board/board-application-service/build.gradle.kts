...
dependencies {
    ...
    implementation(project(":board-system-board:board-application-input-port"))
    implementation(project(":board-system-board:board-application-output-port"))
    testImplementation(testFixtures(project(":board-system-board:board-application-output-port")))
