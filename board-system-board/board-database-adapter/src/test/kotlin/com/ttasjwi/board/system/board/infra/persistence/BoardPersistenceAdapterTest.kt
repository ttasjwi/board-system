...
class BoardPersistenceAdapterTest : BoardDataBaseIntegrationTest() {
    ...
    inner class Save {
        ...
        fun test() {
            ...
            // when
            val findBoard = boardPersistenceAdapter.findByIdOrNull(savedBoard.boardId)!!
    ...
    inner class FindByIdOrNull {
        ...
        fun findSuccessTest() {
            ...
            // when
            val findBoard = boardPersistenceAdapter.findByIdOrNull(board.boardId)!!
        ...
        fun findNullTest() {
            ...
            // when
            val board = boardPersistenceAdapter.findByIdOrNull(boardId)
    ...
    inner class ExistsByName {
        ...
        fun test1() {
            ...
            // when
            val exists = boardPersistenceAdapter.existsByName(savedBoard.name)
        ...
        fun test2() {
            // given
            // when
            val exists = boardPersistenceAdapter.existsByName("음식")
            // then
    ...
    inner class ExistsBySlug {
        ...
        fun test1() {
            ...
            // when
            val exists = boardPersistenceAdapter.existsBySlug(savedBoard.slug)
        ...
        fun test2() {
            // given
            // when
            val exists = boardPersistenceAdapter.existsBySlug("food")
            // then
            assertThat(exists).isFalse()
        }
    }
    ...
    inner class FindBySlugOrNull {
        ...
        fun findSuccessTest() {
            ...
            // when
            val findBoard = boardPersistenceAdapter.findBySlugOrNull(board.slug)!!
        ...
        fun findNullTest() {
            ...
            // when
            val board = boardPersistenceAdapter.findBySlugOrNull(slug)
