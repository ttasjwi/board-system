...
import com.ttasjwi.board.system.domain.auth.external.fixture.ExternalRefreshTokenHolderStorageFixture
...
class RefreshTokenHolderStorageImplTest {
    ...
    inner class FindByMemberIdOrNull {
        ...
        fun testNull() {
            val findRefreshTokenHolder = refreshTokenHolderStorage.findByMemberIdOrNull(2L)
