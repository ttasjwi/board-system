...
import com.ttasjwi.board.system.domain.member.external.ExternalPasswordHandlerFixture
...
class PasswordManagerImplTest {
    ...
    inner class ValidateRawPassword {
        ...
        fun testFailure1() {
            ...
            assertThrows<com.ttasjwi.board.system.domain.member.exception.InvalidPasswordFormatException> { tooShortLengthPasswordResult.getOrThrow() }
        }
        ...
        fun testFailure() {
            ...
            assertThrows<com.ttasjwi.board.system.domain.member.exception.InvalidPasswordFormatException> { tooLongLengthPasswordResult.getOrThrow() }
        }
    }
