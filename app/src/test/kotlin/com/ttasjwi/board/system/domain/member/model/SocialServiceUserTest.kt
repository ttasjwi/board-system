...
class SocialServiceUserTest {
    ...
    inner class Restore {
        ...
        fun test() {
            ...
            // when
            val socialServiceUser = SocialServiceUser.restore(
                socialServiceName,
                socialServiceUserId
            )

            // then
            assertThat(socialServiceUser.service.name).isEqualToIgnoringCase(socialServiceName)
    ...
    inner class ToString {
        ...
        fun test() {
            ...
            // then
            assertThat(str).isEqualTo("SocialServiceUser(service=${socialServiceUser.service}, userId='${socialServiceUser.userId}')")
        }
    }
}
