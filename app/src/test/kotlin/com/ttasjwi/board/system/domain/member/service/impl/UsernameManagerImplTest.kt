...
class UsernameManagerImplTest {
    ...
    inner class Validate {
        ...
        fun testFailureLength1() {
            ...
            val exception =
                assertThrows<InvalidUsernameFormatException> { tooShortLengthUsernameResult.getOrThrow() }
        ...
        fun testFailureLength2() {
            ...
            val exception =
                assertThrows<InvalidUsernameFormatException> { tooLongLengthUsernameResult.getOrThrow() }
        ...
        fun testSpace(value: String) {
            val result = usernameManager.validate(value)
            val exception =
                assertThrows<InvalidUsernameFormatException> { result.getOrThrow() }
