...
class UsernameManagerImplTest {
    ...
    inner class Validate {
        ...
        fun testSuccessLength() {
            val minLengthValue =
                "a".repeat(UsernameManagerImpl.MIN_LENGTH)
            val maxLengthValue =
                "a".repeat(UsernameManagerImpl.MAX_LENGTH)
        ...
        fun testFailureLength1() {
            val tooShortLengthValue =
                "a".repeat(UsernameManagerImpl.MIN_LENGTH - 1)
        ...
        fun testFailureLength2() {
            val tooLongLengthValue =
                "a".repeat(UsernameManagerImpl.MAX_LENGTH + 1)
