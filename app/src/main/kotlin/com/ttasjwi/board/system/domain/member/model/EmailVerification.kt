...
internal constructor(
    ...
    internal fun codeVerify(code: String, currentTime: AppDateTime): EmailVerification {
        if (currentTime >= this.codeExpiresAt) {
            ...
            throw com.ttasjwi.board.system.domain.member.exception.EmailVerificationExpiredException(
                email,
                codeExpiresAt,
                currentTime
            )
        ...
        if (this.code != code) {
            ...
            throw com.ttasjwi.board.system.domain.member.exception.InvalidEmailVerificationCodeException()
        }
