...
class NicknamePolicyFixtureTest {
    ...
    private lateinit var nicknamePolicyFixture: com.ttasjwi.board.system.user.domain.policy.fixture.NicknamePolicyFixture

    @BeforeEach
    fun setup() {
        this.nicknamePolicyFixture = com.ttasjwi.board.system.user.domain.policy.fixture.NicknamePolicyFixture()
    }
    ...
    inner class Validate {
        ...
        fun testFailure() {
            val value =
                com.ttasjwi.board.system.user.domain.policy.fixture.NicknamePolicyFixture.Companion.ERROR_NICKNAME
