package com.ttasjwi.board.system.member.infra.spring.security.oauth2.config

import com.ttasjwi.board.system.member.api.SocialLoginSuccessHandler
import com.ttasjwi.board.system.member.domain.SocialLoginUseCase
import com.ttasjwi.board.system.member.infra.spring.security.oauth2.exceptionhandle.CustomAuthenticationFailureHandler
import com.ttasjwi.board.system.member.infra.spring.security.oauth2.CustomOAuth2AuthorizationRequestResolver
import com.ttasjwi.board.system.member.infra.spring.security.oauth2.principal.CustomOAuth2UserService
import com.ttasjwi.board.system.member.infra.spring.security.oauth2.principal.CustomOidcUserService
import com.ttasjwi.board.system.member.infra.spring.security.oauth2.NullOAuth2AuthorizedClientRepository
...
class OAuth2SecurityConfig(
    ...
    private val customOauth2AuthorizationRequestRedirectFilter: OAuth2AuthorizationRequestRedirectFilter by lazy {
        val oauth2AuthorizationRequestRedirectFilter = OAuth2AuthorizationRequestRedirectFilter(customOAuth2AuthorizationRequestResolver)
