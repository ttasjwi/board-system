...
class ArticleCommentWriterNicknamePersistenceAdapterTest : ArticleCommentDataBaseIntegrationTest() {
    ...
    inner class FindTest {
        ...
        fun testCreate() {
            ...
            val findCommentWriterNickname = articleCommentWriterNicknamePersistenceAdapter.findCommentWriterNickname(commentWriter.userId)!!
        ...
        fun testNotFound() {
            val findCommentWriterNickname = articleCommentWriterNicknamePersistenceAdapter.findCommentWriterNickname(8485585858L)
