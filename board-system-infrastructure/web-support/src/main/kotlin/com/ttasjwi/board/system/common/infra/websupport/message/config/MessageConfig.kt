package com.ttasjwi.board.system.common.infra.websupport.message.config

import com.ttasjwi.board.system.common.message.MessageResolver
import com.ttasjwi.board.system.common.infra.websupport.message.DefaultMessageResolver
...
class MessageConfig(
    ...
    fun messageResolver(): MessageResolver {
        return com.ttasjwi.board.system.common.infra.websupport.message.DefaultMessageResolver(
    ...
    fun generalMessageSource(): MessageSource {
        val messageSource =
            com.ttasjwi.board.system.common.infra.websupport.message.config.MessageConfig.YamlMessageSource()
