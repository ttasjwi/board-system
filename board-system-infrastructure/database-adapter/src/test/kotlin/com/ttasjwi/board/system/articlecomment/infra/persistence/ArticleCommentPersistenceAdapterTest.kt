...
class ArticleCommentPersistenceAdapterTest : DataBaseIntegrationTest() {
    ...
    inner class SaveAndFindTest {
        ...
        fun testSuccess() {
            ...
            // when
            articleCommentArticleCommentPersistenceAdapter.save(articleComment)
            flushAndClearEntityManager()
            val findArticleComment = articleCommentArticleCommentPersistenceAdapter.findById(articleComment.articleCommentId)!!
        ...
        fun testNotFound() {
            // given
            // when
            val findArticleComment = articleCommentArticleCommentPersistenceAdapter.findById(14555665L)
    ...
    fun findAllPageTest() {
        ...
        for (i in 1..10) {
            ...
            articleCommentArticleCommentPersistenceAdapter.save(comment)
        }

        // when
        val articles = articleCommentArticleCommentPersistenceAdapter.findAllPage(
            articleId = articleId,
            offset = 3,
            limit = 3,
        )
    ...
    inner class CountTest {
        ...
        fun test1() {
            ...
            // when
            val count = articleCommentArticleCommentPersistenceAdapter.count(articleId, 9)
        ...
        fun test2() {
            ...
            // when
            val count = articleCommentArticleCommentPersistenceAdapter.count(articleId, 15)
    ...
    inner class FindAllInfiniteScrollTest {
        ...
        fun test1() {
            ...
            // when
            val articles = articleCommentArticleCommentPersistenceAdapter.findAllInfiniteScroll(
                articleId = articleId,
                limit = 7,
        ...
        fun test2() {
            ...
            for (i in 1..50) {
                ...
                articleCommentArticleCommentPersistenceAdapter.save(
                    articleCommentFixture(
