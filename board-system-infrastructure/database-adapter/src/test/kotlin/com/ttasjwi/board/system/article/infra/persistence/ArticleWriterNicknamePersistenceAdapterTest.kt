...
class ArticleWriterNicknamePersistenceAdapterTest : DataBaseIntegrationTest() {
    ...
    inner class FindTest {
        ...
        fun testCreate() {
            ...
            val findWriterNickname = articleArticleWriterNicknamePersistenceAdapter.findWriterNicknameOrNull(user.userId)!!
        ...
        fun testNotFound() {
            val findWriterNickname = articleArticleWriterNicknamePersistenceAdapter.findWriterNicknameOrNull(8485585858L)
