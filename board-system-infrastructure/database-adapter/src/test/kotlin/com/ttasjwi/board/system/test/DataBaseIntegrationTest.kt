...
abstract class DataBaseIntegrationTest {
    ...
    @Autowired
    protected lateinit var articleBoardArticleCountPersistenceAdapter: com.ttasjwi.board.system.article.infra.persistence.BoardArticleCountPersistenceAdapter
    ...
    @Autowired
    protected lateinit var articleCommentArticleCategoryPersistenceAdapter: com.ttasjwi.board.system.articlecomment.infra.persistence.ArticleCategoryPersistenceAdapter
